...
class Block:
    ...
    def __init__(self, typer, prev_hash, list_trans, blkid, timestamp, version, creator,block_num):
        ...
        self.header = {'prev_hash': prev_hash, 'mkl_root': self.mkl_tree.hash_tree[0], 'block_hash': None,
                       ...
                       'blkid': blkid, 'creator': creator,'block_num':block_num, "public_key":None, "type":typer,
                       "2d_chain":None,"signature":None}
